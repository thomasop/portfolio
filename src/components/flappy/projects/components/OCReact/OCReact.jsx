...
const OCReactProjects = [
  {
    ...
    description: `Dans ce projet, j'ai travaillé sur le développement front-end
      ...
      développeurs.`,
    techs: ["HTML", "CSS", "JavaScript", "Git / Github", "SASS"],
    links: [
      {
  ...
  },
  {
    ...
    description: `Ce projet a été une introduction au développement avec JavaScript,
              ...
              de mon projet.`,
    techs: ["HTML", "CSS", "JavaScript", "Git / Github", "SASS", "Figma"],
    links: [
      {
        name: "Lien vers le site",
  ...
  },
  {
    ...
    techs: ["HTML", "CSS", "Git / Github", "JavaScript", "Algorithme", "Jsben"],
    links: [
      {
        name: "Lien vers le site",
...
const OCReact = () => {
  ...
  useEffect(() => {
    ...
    const updateScrollProgress = () => {
      const progress = (Math.abs(xRef.current) / totalScrollWidth) * 100;
      if (progress > 100) {
        setScrollProgress(100);
      } else {
        setScrollProgress(progress);
